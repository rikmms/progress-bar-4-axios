...
`import axios from '@axios'` and `import { loadProgressBar } from '@technologyadvice/axios-progress-bar'` will be added to the imports
`loadProgressBar({}, axios)` will be called
